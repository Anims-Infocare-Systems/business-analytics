                    ...
                    <div className="erdp-popup">
                        ...
                        <div className="erdp-footer">
                            <div className="erdp-footer__range">
                                <span className="erdp-footer__field"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="3" y1="10" x2="21" y2="10"/></svg>{from?FMT(from):"From date"}</span>
                                ...
                                <span className="erdp-footer__field"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="3" y1="10" x2="21" y2="10"/></svg>{to?FMT(to):"To date"}</span>
                                {days && <span className="erdp-footer__days">{days} days</span>}
                            </div>
                            <div className="erdp-footer__btns">
                                <button className="erdp-footer-btn erdp-footer-btn--sec" onClick={()=>{onChange({from:null,to:null});setSelecting(null);setActivePreset(null);}} type="button">Clear</button>
                                <button className="erdp-footer-btn erdp-footer-btn--pri" onClick={()=>setOpen(false)} type="button">Apply</button>
                            </div>
                        </div>
                    </div>
                </PopupPortal>
