                    ...
                    <div className="drp-popup">
                        ...
                        <div className="drp-footer">
                            <div className="drp-footer__range">
                                <div className="drp-footer__input-wrap">
                                    <svg className="drp-footer__input-ico" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                        <rect x="3" y="4" width="18" height="18" rx="2"/><line x1="3" y1="10" x2="21" y2="10"/>
                                    </svg>
                                    <input
                                        className={`drp-footer__input ${inputErr.includes("From") ? "drp-footer__input--err" : from ? "drp-footer__input--set" : ""}`}
                                        type="text"
                                ...
                                <div className="drp-footer__input-wrap">
                                    ...
                                    <input
                                        className={`drp-footer__input ${inputErr.includes("To") ? "drp-footer__input--err" : to ? "drp-footer__input--set" : ""}`}
                                        type="text"
                                        placeholder="DD-MM-YYYY"
                                        value={toInput}
                                ...
                                {days && <span className="drp-footer__days">{days} days</span>}
                                {inputErr && <span className="drp-footer__err">{inputErr}</span>}
                            </div>
                            <div className="drp-footer__btns">
                                <button className="drp-footer-btn drp-footer-btn--sec" onClick={handleClear} type="button">Clear</button>
                                <button className="drp-footer-btn drp-footer-btn--pri" onClick={handleApply} type="button">Apply</button>
                            </div>
                        </div>
                    </div>
                </PopupPortal>
