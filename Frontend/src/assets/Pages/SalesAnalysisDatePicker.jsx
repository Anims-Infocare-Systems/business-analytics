...
export default function SalesAnalysisDatePicker({ from, to, onChange, size, disabled = false }) {
    ...
    return (
        <div className={`sadp-wrap ${size === "small" ? "sadp-wrap--small" : ""}`} ref={wrapRef}>
            <button
                ref={triggerRef}
                className={`sadp-trigger ${open ? "sadp-trigger--open" : ""} ${size === "small" ? "sadp-trigger--small" : ""} ${disabled ? "sadp-trigger--disabled" : ""}`}
