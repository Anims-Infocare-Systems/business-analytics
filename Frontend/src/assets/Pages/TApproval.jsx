...
export default function TApproval() {
    ...
    const _saved = readFilterSession("ba_filter_tapproval", { from: today, to: today, search: "" });
    ...
    useEffect(() => {
        writeFilterSession("ba_filter_tapproval", { from: dateRange.from, to: dateRange.to, search });
